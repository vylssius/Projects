...
class AudioManager:
    ...
    def play_audio(
        ...
        sleep_during_playback=True,  # Whether to sleep while the audio is playing
        delete_file=False,  # Whether to delete the file after playing
        play_using_music=True,  # Whether to use pygame.music or pygame.sound
    ):
